...
public class minor_allignment {

	@Test
	public void minor_allignment() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//div[@class='globalNav-menu']/ul/li[1]/ul/li[6]")).click();           
