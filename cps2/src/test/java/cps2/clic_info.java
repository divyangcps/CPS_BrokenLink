...
public class clic_info {
	
	
	
	@Test
	
	public void clic_info() throws InterruptedException
	
	{
		...
		driver.findElement(By.xpath("//div[@class='globalNav-menu']/ul/li[1]/ul/li[7]")).click();           
...
//
//
//				WebElement expected_tab_text=driver.findElement(By.xpath("//div[@class=\"chapter-head line\"]"));
//
