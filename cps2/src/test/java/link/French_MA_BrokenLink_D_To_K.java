...
public class French_MA_BrokenLink_D_To_K {
	...
	public void setUp() {
		...
		ExtentSparkReporter spark = new ExtentSparkReporter("French_MA_D_To_K.html");
	...
	public void testBrokenLinks() throws Exception {
		...
		for (int i = 0; i < all_items.size(); i++)
		{
			...
			if(current_element.getText().toString().startsWith("L"))
			{
				test.log(Status.PASS, "Alphabar D to K is executed");
                      break;
			}
