...
public class TC_BrokenLink_D_H {
	...
	public void setUp() {
		...
		ExtentSparkReporter spark = new ExtentSparkReporter("TC_BrokenLink_D_to_M.html");
	...
	public void testBrokenLinks() throws Exception {
		...
		for (int i = 0; i < all_items.size(); i++)
		{
			...
			if(current_element.getText().toString().startsWith("N"))
			{
				test.log(Status.PASS, "Alphabar D to M is executed");
                      break;
			}
