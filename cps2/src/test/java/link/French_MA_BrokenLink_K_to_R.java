...
public class French_MA_BrokenLink_K_to_R {
	...
	public void setUp() {
		...
		ExtentSparkReporter spark = new ExtentSparkReporter("French_MA_K_To_R.html");
	...
	public void testBrokenLinks() throws Exception {
		...
		for (int i = 0; i < all_items.size(); i++)
		{
			...
			if(current_element.getText().toString().startsWith("S"))
			{
				test.log(Status.PASS, "Alphabar K to S is executed");
                      break;
			}
