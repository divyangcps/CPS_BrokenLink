...
public class French_TC_BrokenLink_D_to_J {
	...
	public void setUp() {
		...
		ExtentSparkReporter spark = new ExtentSparkReporter("French_TC_D_To_J.html");
	...
	public void testBrokenLinks() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='globalNav-menu']/ul/li[1]/ul/li[8]")));
		...
		driver.findElement(By.xpath("//button[text()='D']")).click();
		...
		for (int i = 0; i < all_items.size(); i++)
		{
			...
			if(current_element.getText().toString().startsWith("K"))
			{
				test.log(Status.PASS, "Alphabar D to J is executed");
                      break;
			}
