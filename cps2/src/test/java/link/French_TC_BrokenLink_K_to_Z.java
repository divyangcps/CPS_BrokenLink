...
public class French_TC_BrokenLink_K_to_Z {
	...
	public void setUp() {
		...
		ExtentSparkReporter spark = new ExtentSparkReporter("ExtentReport_K_to_Z.html");
	...
	public void testBrokenLinks() throws Exception {
		...
		driver.findElement(By.xpath("//button[text()='L']")).click();
